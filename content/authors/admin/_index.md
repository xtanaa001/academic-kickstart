...
I am broadly interested in the **optimization of networked systems**, with particular applications to computer networks, cloud computing and smart grid. My research tends to focus on the interplay between mechanism design, machine learning, and online algorithms, with a focus on understanding the synergy between incentives, learning and algorithms for the optimization of real-world networked systems in the presence of private data held by self-interested agents. For more details about my work, please see [Research](/research) page. 