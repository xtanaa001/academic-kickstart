...
My research primarily lies in the **optimization of networked systems**, with major applications to [data networks](/research/#data-networks), [cloud computing](/research/#cloud-computing) and [smart grid](/research/#smart-grid). In particular, my research tends to focus on optimizing the user interactions in networked systems in the presence of dynamics and self-interested user behaviors.  

My recent research also features the interplay between mechanism design, online algorithms, and  machine learning, with a focus on understanding and creating the **synergy between incentives, data and decisions**. For more details about my work, please see [Research](/research) page. 