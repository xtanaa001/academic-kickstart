...
I am broadly interested in the **optimization of networked systems**, with major applications to [computer networks](/research/#computer-networks), [cloud computing](/research/#cloud-computing) and [smart grid](/research/#smart-grid). More specifically, my research primarily focuses on the design of incentives so as to optimize the performance of networked systems with self-interested users. 

In addition, I also study **incentives and online decision-making** in general resource allocation problems, with a focus on understanding the interplay between mechanism design, online algorithms, and  machine learning. For more details about my work, please see [Research](/research) page. 