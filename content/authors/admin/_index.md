...
I am broadly interested in the **optimization of networked systems**, with major applications to [data networks](/research/#data-networks), [cloud computing](/research/#cloud-computing) and [smart grid](/research/#smart-grid). More specifically, my research primarily focuses on characterizing the role of incentives and user behaviors in the optimization of networked systems, where users interact and possibly pursue conflicting objectives in the presence of dynamics. 

I also study incentives and decision-making in a more general setting, with a focus on understanding the **interplay between mechanism design, online algorithms, and  machine learning**. For more details about my work, please see [Research](/research) page. 